...
const C2 = () => {
    ...
    <div className="cal2">
        ...
        <div className="scheduler">
            ...
            <DayView title="" numberOfDays={1} slotDuration={60} slotDivisions={2} startTime={"07:00"} endTime={"19:00"} workDayStart={"08:00"} workDayEnd={"18:00"} />
            </Scheduler>
        </div>
