...
function UpdateBatchEvent (props) {
    ...
    const handleUpdateEvent = async (id, defaultTitle, inputTitle, defaultStartTime, inputStartTime, defaultDuration, inputDuration) =>{ 
        ...
        try{
            let StartTimeInMilliSeconds = +new Date(defaultStartTime);
        await axios.put(`api/showroom/schedule/events/bulk/${StartTimeInMilliSeconds}`, messageData, {
            headers: {"Content-Type": "application/json"},
            withCredentials: true
            }).then((res) => {
            ...
            {event && (
                <div className="addNewEvent">
                        ...
                        <div key={event.meetid}>  
                                ...
                                <div>                        
                                    <h2>Update Multiple Events to Accomodate New Start Time and Duration</h2>
...
export default withRouter(UpdateBatchEvent);